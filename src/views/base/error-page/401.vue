 ...
 * @Date         : 2020-12-14 14:50:59
 * @LastEditTime : 2020-12-15 16:22:42
 * @FilePath     : /kspcims-ts-vue-element-template-demo/src/views/base/error-page/401.vue
-->
<template>
    ...
    <el-row>
      <el-col :span="12">
        ...
        <ul class="list-unstyled">
          ...
          <li class="link-type">
            <a href="https://github.com/giannuo">随便看看</a>
          </li>
          <li>
            <a
              href="#"
